				...
				<div class="panel panel-default address-billing">
					...
					<div class="panel-body collapse" id="address-payment">
						...
						<div class="form-list">
							...
							<div class="form-item form-group row middlename">

								<label class="col-md-4" for="address-payment-middlename">
								<?= $enc->html( $this->translate( 'client', 'Middle name' ), $enc::TRUST ) ?>
								</label>
								<div class="col-md-8">
								<input class="form-control" type="text"
								id="address-payment-middlename"
								name="<?= $enc->attr( $this->formparam( array( 'address', 'payment', 'customer.middlename' ) ) ) ?>"
								value="<?= $enc->attr( $this->value( $addr, 'customer.middlename' ) ) ?>"
								placeholder="<?= $enc->attr( $this->translate( 'client', 'Middle name' ) ) ?>"
								>
							</div>
